...
public class Conta {
    ...
    public Conta(String username,String password, PrintWriter out, BufferedReader in) {
        this.in = in;
        this.out = out;
    ...
    public void win() {
        ...
        seqWins ++;
        totWins ++;
        if(rankWins >= 1 && rank<9) {rank++;rankWins = 0;}
        else rankWins++;
    }
    ...
    public void loss() {
      seqWins = 0;
      nrJogos ++;
      if(rankWins < 1 && rank>0){rank--;rankWins = 1}
      else rankWins--;
    }
