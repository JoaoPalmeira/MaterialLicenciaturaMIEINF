...
/**
 * Escreva a descrição da classe QUELASSE aqui.
 * 
 * @author (seu nome) 
 * @version (número de versão ou data)
 */
public class QUELASSE
{
   ...
   public static String somaDatas(int d1, int h1, int m1, int s1, int d2, int h2, int m2, int s2){
       ...
       String r = data.get(Calendar.DAY_OF_MONTH)+"D" + data.get(Calendar.HOUR_OF_DAY)+"H"; //falta completar
