...
public class Testes
{
   ...
   //Cliente(String email, String nome, String password, String morada, LocalDate dataNascimento, Map<Integer,Viagem> viagens, Espaco2D localizacao)
    ...
    public void mainTest() {
        ...
        Moto moto1 = new Moto(viagens1, 50, 1, 1, espaco, matrix, 2, -1);
        Moto moto2 = new Moto(viagens1, 45, 1, 2, espaco, matrix2, 3, -1);
        Moto moto3 = new Moto(viagens1, 50, 1, 1, espaco, matrix3, 2, -1);
        Moto moto4 = new Moto(viagens1, 55, 1, 1, espaco, matrix4, 2, -1);
        Moto moto5 = new Moto(viagens1, 40, 2, 3, espaco, matrix5, 2, -1);
       
        Carrinha carrinha1 = new Carrinha(viagens1, 70, 1.2, 1, espaco, matrix6, 9, -1, viagensEmEspera);
        Carrinha carrinha2 = new Carrinha(viagens1, 80, 1.5, 2, espaco, matrix7, 9, -1, viagensEmEspera);
        Carrinha carrinha3 = new Carrinha(viagens1, 70, 1.2, 1, espaco, matrix8, 9, -1, viagensEmEspera);
        Carrinha carrinha4 = new Carrinha(viagens1, 60, 1.0, 3, espaco, matrix9, 8, -1, viagensEmEspera);
        Carrinha carrinha5 = new Carrinha(viagens1, 75, 1.0, 2, espaco, matrix10, 9, -1, viagensEmEspera);
        
        String matrix11= "EC-05-06";
        String matrix12= "SD-02-14";
        String matrix13= "SS-10-10";
        String matrix14= "FL-11-09";
        String matrix15= "RT-05-01";
                
        CarroLigeiro carro1 = new CarroLigeiro(viagens1, 80, 1.5, 1, espaco, matrix11, -1, 5, viagensEmEspera);
        CarroLigeiro carro2 = new CarroLigeiro(viagens1, 60, 1.1, 2, espaco, matrix12, -1, 5, viagensEmEspera);
        CarroLigeiro carro3 = new CarroLigeiro(viagens1, 70, 1.2, 1, espaco, matrix13, -1, 5, viagensEmEspera);
        CarroLigeiro carro4 = new CarroLigeiro(viagens1, 70, 1.2, 1, espaco, matrix14, -1, 5, viagensEmEspera);
        CarroLigeiro carro5 = new CarroLigeiro(viagens1, 70, 1.5, 1, espaco, matrix15, -1, 5, viagensEmEspera);
        ...
        try {
            Cliente c = new Cliente("carlao@gmail.com","Daniel","123456daniel","Braga",dataNascimento_a,viagens1,espaco1);  // Preencher parâmetros do construtor
            umer.adiciona(c);
            email12 = c.getEmail();
        ...
        try{
            umer.solicitarViagemM(e1, matrix, email12);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e2, matrix2, email12);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e3, matrix3, email13);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e4, matrix2, email14);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e5, matrix5, email14);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e1, matrix4, email15);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemC(e1, matrix6, email16);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemC(e2, matrix7, email18);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemC(e7, matrix9, email19);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemC(e8, matrix7, email17);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e5, matrix9, email12);
        } catch (Exception e) {
            fail();
        }
        
        try{
            umer.solicitarViagemM(e1, matrix6, email14);
        } catch (Exception e) {
            fail();
        }
