...
public class CartaoCliente
{
    ...
    public boolean equals(Object o){
        ...
        return n.getValorTotal() == valorTotal && n.getPontos() == pontos && n.getCodigo().equals(codigo) && n.getNome().equals(nome) && n.getValorBonus() == valorBonus;
    }
    
    public String toString() {
        String sign = ",";
        return valorTotal+sign+pontos+sign+codigo+sign+nome+sign+valorBonus;
    }
}
