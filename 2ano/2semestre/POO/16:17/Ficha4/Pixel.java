...
public class Pixel
{
   ...
   public Pixel( double cx, double cy, int cz){
    ...
    public void desloca(double x1, double y1){
        this.x=this.x+x1;
        this.y=this.y+y1;
    }
    
    public void mudarCor(int cor1){
        if(cor1>=0 && cor1<=15){
            this.cor=cor;
        }
    }
    ...
    public String nomeCor(){
        ...
        String[] cores={"Preto","Azul marinho","Verde escuro","Azul petróleo","Castanho","Púrpura",
                        "Verde oliva", "Cinza claro", "Cinza escuro", "Azul", "Verde",
                        "Azul turquesa","Vermelho", "Fúcsia","Amarelo","Branco"};
        return cores[c];
    }
