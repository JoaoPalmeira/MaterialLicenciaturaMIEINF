...
public class HoteisInc implements Serializable {
  ...
  public static Comparator<Hotel> getOrdem(String nome) {
   ...
   /**
     ...
     */
    public void adiciona(Hotel h) throws HotelRepetidoException {
        if(hoteis.containsKey(h.getCodigo())){
           throw new HotelRepetidoException("Codigo de hotel repetido");          
        }
    ...
    public void adiciona(Set<Hotel> hs) throws HotelRepetidoException {
        for(Hotel h : hs) {
            adiciona(h);
        }
    }
