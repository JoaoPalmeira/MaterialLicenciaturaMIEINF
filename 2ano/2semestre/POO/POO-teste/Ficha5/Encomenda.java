...
/**
 * Classe que implementa uma Encomenda (cf. exercício Ficha 5).
 *
 * @author MaterialPOO
 * @version 20180323
 */
public class Encomenda {
    ...
    public Encomenda(String nomeCliente, int nif, String morada, int nEnc,
                    LocalDate data, List<LinhaEncomenda> linhasEnc, Map<Integer,Encomenda> e) {
        ...
        for(Encomenda l : e.values()){
            this.enc.put(e.getNif(),l.clone());
        }
    }
    public void setEnc(Map<Integer,Encomenda> e){
        this.enc=new HashMap<>();
        for(Encomenda l : e.values()){
            this.enc.put(e.getNif(),l.clone());
        }
